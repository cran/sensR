...
<<example3-3>>=
anova(fm2, update(fm2,location = ~.-gender))
@ 
...
## load("C:/Users/rhbc/Documents/Phd/Papers/twoAC/HSdata.RData")
load("HSdata.RData")
repData <- hs.long
@ 
...
fm3.agq <- clmm(preference ~ reference, random = cons, nAGQ = 10, 
...
## load("C:/Users/rhbc/Documents/Phd/Papers/twoAC/profileSigma.RData")
...
\begin{figure}
  ...
  \caption{Profile likelihood for $\sigma_{d'}$ Horizontal lines
