...
summary(bbc <- betabin(X, corr = TRUE, pGuess = 1/3))

target <- c(0.1175015, 0.2146566)
stopifnot(all(abs(coef(bbc) - target) < 1e-5))
## Methods:
logLik(bbc)
vcov(bbc)
AIC(bbc)
...
X3 <- cbind(x, 100)
summary(betabin(X3, pGuess=1/3))
summary(betabin(X3, cor = 0, pGuess=1/3))
...
X4 <- cbind(x, 4)
sum(x)/(12*4) # 5
summary(betabin(X4, pGuess=1/3))
summary(betabin(X4, cor = 0, pGuess=1/3))
...
(X6 <- cbind(x, 4))
sum(x)/(12*4) # 5
summary(betabin(X6, pGuess=1/3))
summary(betabin(X6, cor = 0, pGuess=1/3))
...
(X7 <- cbind(x, 4))
sum(x)/(12*4) # 5
summary(betabin(X7, pGuess=1/3))
summary(betabin(X7, cor = 0, pGuess=1/3))
...
(X8 <- cbind(x, 4))
sum(x)/(12*4) # 5
summary(betabin(X8, pGuess=1/3))
summary(betabin(X8, cor = 0, pGuess=1/3))
...
(X9 <- cbind(x, 4))
sum(x)/(12*4) # 5
summary(betabin(X9, pGuess=1/3))
summary(betabin(X9, cor = 0, pGuess=1/3))
...
X <- cbind(x, 2); X
summary(bbc <- betabin(X, pGuess=1/2))
## Moment estimates: (mu, gamma) = (0.667, 0.700) (Bi, 2006)
## These ML estimates and correspond to the ML
...
X <- cbind(x, 4); X
summary(bbc <- betabin(X, pGuess=1/3))
